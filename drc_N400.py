...
sys.path.append('Documents/GitHub/Dynamic_Rank_Centrality/modules')
...
with open("parameters_RC_N400.txt", "wb") as param:
    pickle.dump(parameters, param)

with open("MSE_RC_N400.txt", "wb") as mse_rc:
    pickle.dump(MSE_RC, mse_rc)
    
with open("MSE_MLE_N400.txt", "wb") as mse_mle:
    pickle.dump(MSE_MLE, mse_mle)
    
with open("borda_count_N400.txt", "wb") as borda_count:
    pickle.dump(error_borda, borda_count)
    
with open("error_MLE_N400.txt", "wb") as error_mle:
    pickle.dump(error_MLE, error_mle)
    
with open("error_RC_N400.txt", "wb") as error_rc:
